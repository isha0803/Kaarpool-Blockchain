...
def send_eth(account="0x1256BBcc2c63703AdeB176AAd634ba6793EeB24E"):
    # ganache_url = 'IMPORTYOURURL'
    # web3 = Web3(Web3.HTTPProvider(ganache_url))
    account_1 = w3.toChecksumAddress("0x1256BBcc2c63703AdeB176AAd634ba6793EeB24E")
    private_key1 = '508e0795d166bc7dc0d68097387fa31f1d3e01662b92f0281ff909c8b29d9f23'
    account_2 = w3.toChecksumAddress("0xa35948d0a9c95bA0C6C4fE97b6827D96e28Da05E")
...
def send_eth_api(amountInINR, driverAccount="0xa35948d0a9c95bA0C6C4fE97b6827D96e28Da05E", riderAccount="0x1256BBcc2c63703AdeB176AAd634ba6793EeB24E"):
    # ganache_url = 'IMPORTYOURURL'
    # web3 = Web3(Web3.HTTPProvider(ganache_url))
