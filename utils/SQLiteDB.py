...
def createRiderTableIfNotExist():
    sqlConnection = sql.connect(r"C:\Users\Isha\OneDrive\Documents\Desktop\Blockchain\Blockchain-main (6)\Blockchain-main\Kaarpool-Blockchain\utils\SQLiteDB\riderData.db")
    print(sqlConnection)
...
def createDriverTableIfNotExist():
    sqlConnection = sql.connect(r"C:\Users\Isha\OneDrive\Documents\Desktop\Blockchain\Blockchain-main (6)\Blockchain-main\Kaarpool-Blockchain\utils\SQLiteDB\driverData.db")
    print(sqlConnection)
...
def createRiderRouteTableIfNotExist():
    sqlConnection = sql.connect(r"C:\Users\Isha\OneDrive\Documents\Desktop\Blockchain\Blockchain-main (6)\Blockchain-main\Kaarpool-Blockchain\utils\SQLiteDB\riderRouteData.db")
    print(sqlConnection)
...
def createDriverRouteTableIfNotExist():
    sqlConnection = sql.connect(r"C:\Users\Isha\OneDrive\Documents\Desktop\Blockchain\Blockchain-main (6)\Blockchain-main\Kaarpool-Blockchain\utils\SQLiteDB\driverRouteData.db")
    print(sqlConnection)
...
def insertDriverData(name, contactNo, password, gender, email, vehicle, licenseNumber, licenseValidity,
                     insuranceNumber):
    con = sql.connect(r"C:\Users\Isha\OneDrive\Documents\Desktop\Blockchain\Blockchain-main (6)\Blockchain-main\Kaarpool-Blockchain\utils\SQLiteDB\driverData.db")
    cur = con.cursor()
...
def insertRiderData(name, contactNo, password, gender, email):
    con = sql.connect(r"C:\Users\Isha\OneDrive\Documents\Desktop\Blockchain\Blockchain-main (6)\Blockchain-main\Kaarpool-Blockchain\utils\SQLiteDB\riderData.db")
    cur = con.cursor()
...
def insertDriverRouteData(name, source, destination, availableSeats, starttime, endtime):
    con = sql.connect(r"C:\Users\Isha\OneDrive\Documents\Desktop\Blockchain\Blockchain-main (6)\Blockchain-main\Kaarpool-Blockchain\utils\SQLiteDB\driverRouteData.db")
    cur = con.cursor()
    cur.execute(
...
def insertRiderRouteData(name, source, destination, time, confirmRideStatus, driverName):
    con = sql.connect(r"C:\Users\Isha\OneDrive\Documents\Desktop\Blockchain\Blockchain-main (6)\Blockchain-main\Kaarpool-Blockchain\utils\SQLiteDB\riderRouteData.db")
    cur = con.cursor()
    cur.execute(
